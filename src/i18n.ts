export const zhCN = {
  ...
  'Force compact non-interactive text output': '强制使用紧凑的非交互文本输出',
  'Installing Corretto {0}': '正在安装 Corretto {0}',
  'Nova keyboard help': 'Nova 键盘帮助',
  'Press / to search, ? for help': '按 / 搜索，按 ? 查看帮助',
  'Press ? or Esc to close': '按 ? 或 Esc 关闭',
  'Remote version is no longer available. Refresh and retry.': '远程版本已不可用，请刷新后重试。',
  'Search': '搜索',
  'Type to search, Enter to apply, Esc to clear': '输入搜索内容，按 Enter 应用，按 Esc 清除',
  ...
  'refresh': '刷新',
  'quit': '退出',
  '↑/↓ select · Enter action · / search · ? help · q quit': '↑/↓ 选择 · Enter 执行 · / 搜索 · ? 帮助 · q 退出',
  ...
  'Cannot read installation record {0}: {1}': '无法读取安装记录 {0}：{1}',
  ...
  'Remove a stale write lock after inspection': '检查后删除过期写锁',
  'Write lock present: {0}': '存在写锁：{0}',
  'Removed write lock.': '已删除写锁。',
  'No write lock found.': '未找到写锁。',
  'unknown PID': '未知 PID',
  'Write lock changed while repairing.': '修复写锁时锁文件发生变化。',
  'Write lock is held by a running process.': '写锁仍由运行中的进程持有。',
